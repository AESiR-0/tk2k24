...
export default function About() {
    return (
        <div id="about" className="flex flex-col text-justify justify-center w-full h-screen px-32 gap-7 max-md:px-4 max-md:min-h-screen">
            <h1 className="text-6xl text-center font-semibold mb-12 max-md:mb-2 max-md:text-4xl">ABOUT US</h1>
