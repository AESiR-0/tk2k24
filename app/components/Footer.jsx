...
export default function Footer() {
  ...
  return (
    <div
      id="footer"
      className="h-full space-y-8 overflow-hidden max-md:px-0 max-md:py-0"
    >
      <nav className="flex flex-wrap justify-center -mx-5 -my-2">
        ...
        <div className="px-5 py-2">
          <Link
            href="https://drive.google.com/file/d/1rFHzLbvaIpFTAs2RUULlK88roh69EA8D/view?usp=sharing"
            className="text-base leading-6 text-gray-500 hover:text-gray-100"
          >
            Code of Conduct
          </Link>
      ...
      <div className="flex justify-center mt-8 space-x-6">
        ...
        <a
          href="https://instagram.com/techkaushalya24"
          className="text-gray-400 hover:text-gray-100"
        >
        ...
        <a
          href="https://x.com/kaushalya_2k23?t=Kcot_DpNjtEv_5VTa-IMoQ&s=09"
          className="text-gray-400 hover:text-gray-100"
        >
      ...
      <div className="flex w-screen M-0 h-full  justify-center">
      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3671.671569519845!2d72.5430593753012!3d23.035828215833416!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e84eac78b4d07%3A0x2d6caa89e8aa28fd!2sRollwala%20Computer%20Center!5e0!3m2!1sen!2sin!4v1706776042492!5m2!1sen!2sin" className="w-full" ></iframe>
      </div>
