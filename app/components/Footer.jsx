...
export default function Footer() {
  return (
    <div
      id="footer"
      className="h-full px-4 py-10 space-y-8 overflow-hidden sm:px-6 lg:px-8"
    >
      <nav className="flex flex-wrap justify-center -mx-5 -my-2">
        ...
        <div className="px-5 py-2">
          <Link
            href="https://drive.google.com/file/d/11YTjsvPZsPK2JUxelHThO9SEIAwpScpD/view?usp=drivesdk"
            className="text-base leading-6 text-gray-500 hover:text-gray-100"
          >
            Rule Book
          </Link>
